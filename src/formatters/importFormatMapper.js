...
/**
 * DYNAMICS365 — Microsoft Dynamics 365 General Journal import
 * Auto-generated by IntelliMatch MCP Server
 */
function toLedgerDYNAMICS365(rec) {
  return {
    JournalNum: rec.TxnID,
    AccountNum: rec.LedgerAccount,
    TransDate: rec.TransactionDate,
    CurrencyCode: rec.Currency,
    AmountCurDebit: rec.DebitAmount,
    AmountCurCredit: rec.CreditAmount,
    Txt: rec.Description,
    Voucher: rec.ReferenceNumber,
    MatchType: rec.MatchType
  };
}
...
function applyLedgerImportFormat(records, importFmt) {
  switch (importFmt.toUpperCase()) {
    ...
    case 'DYNAMICS365': return records.map(toLedgerDYNAMICS365);
